...
// method
	...
	public void toMatrix (final float[] matrix) {
		...
		matrix[Matrix4.M11] = 1 - 2 * (yy + zz);
		matrix[Matrix4.M12] = 2 * (xy - zw);
		matrix[Matrix4.M13] = 2 * (xz + yw);
		matrix[Matrix4.M14] = 0;
		matrix[Matrix4.M21] = 2 * (xy + zw);
		matrix[Matrix4.M22] = 1 - 2 * (xx + zz);
		matrix[Matrix4.M23] = 2 * (yz - xw);
		matrix[Matrix4.M24] = 0;
		matrix[Matrix4.M31] = 2 * (xz - yw);
		matrix[Matrix4.M32] = 2 * (yz + xw);
		matrix[Matrix4.M33] = 1 - 2 * (xx + yy);
		matrix[Matrix4.M34] = 0;
		matrix[Matrix4.M41] = 0;
		matrix[Matrix4.M42] = 0;
		matrix[Matrix4.M43] = 0;
		matrix[Matrix4.M44] = 1;
	}
	...
	public Quaternion setFromMatrix (boolean normalizeAxes, Matrix4 matrix) {
		return setFromAxes(normalizeAxes, matrix.val[Matrix4.M11], matrix.val[Matrix4.M12], matrix.val[Matrix4.M13],
			matrix.val[Matrix4.M21], matrix.val[Matrix4.M22], matrix.val[Matrix4.M23], matrix.val[Matrix4.M31],
			matrix.val[Matrix4.M32], matrix.val[Matrix4.M33]);
	}
	...
	public Quaternion setFromMatrix (boolean normalizeAxes, Matrix3 matrix) {
		return setFromAxes(normalizeAxes, matrix.val[Matrix3.M11], matrix.val[Matrix3.M12], matrix.val[Matrix3.M13],
			matrix.val[Matrix3.M21], matrix.val[Matrix3.M22], matrix.val[Matrix3.M23], matrix.val[Matrix3.M31],
			matrix.val[Matrix3.M32], matrix.val[Matrix3.M33]);
	}
