...
public class Matrix4 implements Serializable {
    ...
    public Matrix4 set(float translationX, float translationY, float translationZ, float quaternionX, float quaternionY,
        ...
        val[M12] = (xy - wz);
        val[M13] = (xz + wy);
        val[M14] = translationX;

        val[M21] = (xy + wz);
        val[M22] = (1.0f - (xx + zz));
        val[M23] = (yz - wx);
        val[M24] = translationY;

        val[M31] = (xz - wy);
        val[M32] = (yz + wx);
        val[M33] = (1.0f - (xx + yy));
        val[M34] = translationZ;
    ...
    public Matrix4 set(float translationX, float translationY, float translationZ, float quaternionX, float quaternionY,
        ...
        val[M11] = scaleX * (1.0f - (yy + zz));
        val[M12] = scaleY * (xy - wz);
        val[M13] = scaleZ * (xz + wy);
        val[M14] = translationX;

        val[M21] = scaleX * (xy + wz);
        val[M22] = scaleY * (1.0f - (xx + zz));
        val[M23] = scaleZ * (yz - wx);
        val[M24] = translationY;

        val[M31] = scaleX * (xz - wy);
        val[M32] = scaleY * (yz + wx);
        val[M33] = scaleZ * (1.0f - (xx + yy));
        val[M34] = translationZ;
     ...
     */
    public Matrix4 inv() {
        float l_det = val[M41] * val[M32] * val[M23] * val[M14] - val[M31] * val[M42] * val[M23] * val[M14] - val[M41] * val[M22]
                * val[M33] * val[M14] + val[M21] * val[M42] * val[M33] * val[M14] + val[M31] * val[M22] * val[M43] * val[M14] - val[M21]
                * val[M32] * val[M43] * val[M14] - val[M41] * val[M32] * val[M13] * val[M24] + val[M31] * val[M42] * val[M13] * val[M24]
                + val[M41] * val[M12] * val[M33] * val[M24] - val[M11] * val[M42] * val[M33] * val[M24] - val[M31] * val[M12] * val[M43]
                * val[M24] + val[M11] * val[M32] * val[M43] * val[M24] + val[M41] * val[M22] * val[M13] * val[M34] - val[M21] * val[M42]
                * val[M13] * val[M34] - val[M41] * val[M12] * val[M23] * val[M34] + val[M11] * val[M42] * val[M23] * val[M34] + val[M21]
                * val[M12] * val[M43] * val[M34] - val[M11] * val[M22] * val[M43] * val[M34] - val[M31] * val[M22] * val[M13] * val[M44]
                + val[M21] * val[M32] * val[M13] * val[M44] + val[M31] * val[M12] * val[M23] * val[M44] - val[M11] * val[M32] * val[M23]
                * val[M44] - val[M21] * val[M12] * val[M33] * val[M44] + val[M11] * val[M22] * val[M33] * val[M44];
        if (l_det == 0f) throw new RuntimeException("non-invertible matrix");
        float inv_det = 1.0f / l_det;
        tmp[M11] = val[M23] * val[M34] * val[M42] - val[M24] * val[M33] * val[M42] + val[M24] * val[M32] * val[M43] - val[M22]
                * val[M34] * val[M43] - val[M23] * val[M32] * val[M44] + val[M22] * val[M33] * val[M44];
        tmp[M12] = val[M14] * val[M33] * val[M42] - val[M13] * val[M34] * val[M42] - val[M14] * val[M32] * val[M43] + val[M12]
                * val[M34] * val[M43] + val[M13] * val[M32] * val[M44] - val[M12] * val[M33] * val[M44];
        tmp[M13] = val[M13] * val[M24] * val[M42] - val[M14] * val[M23] * val[M42] + val[M14] * val[M22] * val[M43] - val[M12]
                * val[M24] * val[M43] - val[M13] * val[M22] * val[M44] + val[M12] * val[M23] * val[M44];
        tmp[M14] = val[M14] * val[M23] * val[M32] - val[M13] * val[M24] * val[M32] - val[M14] * val[M22] * val[M33] + val[M12]
                * val[M24] * val[M33] + val[M13] * val[M22] * val[M34] - val[M12] * val[M23] * val[M34];
        tmp[M21] = val[M24] * val[M33] * val[M41] - val[M23] * val[M34] * val[M41] - val[M24] * val[M31] * val[M43] + val[M21]
                * val[M34] * val[M43] + val[M23] * val[M31] * val[M44] - val[M21] * val[M33] * val[M44];
        tmp[M22] = val[M13] * val[M34] * val[M41] - val[M14] * val[M33] * val[M41] + val[M14] * val[M31] * val[M43] - val[M11]
                * val[M34] * val[M43] - val[M13] * val[M31] * val[M44] + val[M11] * val[M33] * val[M44];
        tmp[M23] = val[M14] * val[M23] * val[M41] - val[M13] * val[M24] * val[M41] - val[M14] * val[M21] * val[M43] + val[M11]
                * val[M24] * val[M43] + val[M13] * val[M21] * val[M44] - val[M11] * val[M23] * val[M44];
        tmp[M24] = val[M13] * val[M24] * val[M31] - val[M14] * val[M23] * val[M31] + val[M14] * val[M21] * val[M33] - val[M11]
                * val[M24] * val[M33] - val[M13] * val[M21] * val[M34] + val[M11] * val[M23] * val[M34];
        tmp[M31] = val[M22] * val[M34] * val[M41] - val[M24] * val[M32] * val[M41] + val[M24] * val[M31] * val[M42] - val[M21]
                * val[M34] * val[M42] - val[M22] * val[M31] * val[M44] + val[M21] * val[M32] * val[M44];
        tmp[M32] = val[M14] * val[M32] * val[M41] - val[M12] * val[M34] * val[M41] - val[M14] * val[M31] * val[M42] + val[M11]
                * val[M34] * val[M42] + val[M12] * val[M31] * val[M44] - val[M11] * val[M32] * val[M44];
        tmp[M33] = val[M12] * val[M24] * val[M41] - val[M14] * val[M22] * val[M41] + val[M14] * val[M21] * val[M42] - val[M11]
                * val[M24] * val[M42] - val[M12] * val[M21] * val[M44] + val[M11] * val[M22] * val[M44];
        tmp[M34] = val[M14] * val[M22] * val[M31] - val[M12] * val[M24] * val[M31] - val[M14] * val[M21] * val[M32] + val[M11]
                * val[M24] * val[M32] + val[M12] * val[M21] * val[M34] - val[M11] * val[M22] * val[M34];
        tmp[M41] = val[M23] * val[M32] * val[M41] - val[M22] * val[M33] * val[M41] - val[M23] * val[M31] * val[M42] + val[M21]
                * val[M33] * val[M42] + val[M22] * val[M31] * val[M43] - val[M21] * val[M32] * val[M43];
        tmp[M42] = val[M12] * val[M33] * val[M41] - val[M13] * val[M32] * val[M41] + val[M13] * val[M31] * val[M42] - val[M11]
                * val[M33] * val[M42] - val[M12] * val[M31] * val[M43] + val[M11] * val[M32] * val[M43];
        tmp[M43] = val[M13] * val[M22] * val[M41] - val[M12] * val[M23] * val[M41] - val[M13] * val[M21] * val[M42] + val[M11]
                * val[M23] * val[M42] + val[M12] * val[M21] * val[M43] - val[M11] * val[M22] * val[M43];
        tmp[M44] = val[M12] * val[M23] * val[M31] - val[M13] * val[M22] * val[M31] + val[M13] * val[M21] * val[M32] - val[M11]
        ...
        val[M14] = tmp[M14] * inv_det;
        val[M21] = tmp[M21] * inv_det;
        val[M22] = tmp[M22] * inv_det;
        val[M23] = tmp[M23] * inv_det;
        val[M24] = tmp[M24] * inv_det;
        val[M31] = tmp[M31] * inv_det;
        val[M32] = tmp[M32] * inv_det;
        val[M33] = tmp[M33] * inv_det;
        val[M34] = tmp[M34] * inv_det;
        val[M41] = tmp[M41] * inv_det;
        val[M42] = tmp[M42] * inv_det;
        val[M43] = tmp[M43] * inv_det;
        val[M44] = tmp[M44] * inv_det;
        return this;
    }
     ...
     */
    public float det() {
        return val[M41] * val[M32] * val[M23] * val[M14] - val[M31] * val[M42] * val[M23] * val[M14] - val[M41] * val[M22]
                * val[M33] * val[M14] + val[M21] * val[M42] * val[M33] * val[M14] + val[M31] * val[M22] * val[M43] * val[M14] - val[M21]
                * val[M32] * val[M43] * val[M14] - val[M41] * val[M32] * val[M13] * val[M24] + val[M31] * val[M42] * val[M13] * val[M24]
                + val[M41] * val[M12] * val[M33] * val[M24] - val[M11] * val[M42] * val[M33] * val[M24] - val[M31] * val[M12] * val[M43]
                * val[M24] + val[M11] * val[M32] * val[M43] * val[M24] + val[M41] * val[M22] * val[M13] * val[M34] - val[M21] * val[M42]
    ...
    public Matrix4 setToTranslationAndScaling(Vector3 translation, Vector3 scaling) {
        idt();
        val[M14] = translation.x;
        val[M24] = translation.y;
        val[M34] = translation.z;
        val[M11] = scaling.x;
        val[M22] = scaling.y;
        val[M33] = scaling.z;
        return this;
    ...
    public String toString() {
        return "[" + val[M11] + "|" + val[M12] + "|" + val[M13] + "|" + val[M14] + "]\n" + "[" + val[M21] + "|" + val[M22] + "|"
    ...
    public float getScaleXSquared() {
        return val[Matrix4.M11] * val[Matrix4.M11] + val[Matrix4.M12] * val[Matrix4.M12] + val[Matrix4.M13] * val[Matrix4.M13];
    }
    ...
    public float getScaleYSquared() {
        return val[Matrix4.M21] * val[Matrix4.M21] + val[Matrix4.M22] * val[Matrix4.M22] + val[Matrix4.M23] * val[Matrix4.M23];
    }
    ...
    public float getScaleZSquared() {
        return val[Matrix4.M31] * val[Matrix4.M31] + val[Matrix4.M32] * val[Matrix4.M32] + val[Matrix4.M33] * val[Matrix4.M33];
    }
    ...
    public float getScaleX() {
        return (MathUtils.isZero(val[Matrix4.M12]) && MathUtils.isZero(val[Matrix4.M13])) ? Math.abs(val[Matrix4.M11])
    ...
    public float getScaleY() {
        return (MathUtils.isZero(val[Matrix4.M21]) && MathUtils.isZero(val[Matrix4.M23])) ? Math.abs(val[Matrix4.M22])
    ...
    public float getScaleZ() {
        return (MathUtils.isZero(val[Matrix4.M31]) && MathUtils.isZero(val[Matrix4.M32])) ? Math.abs(val[Matrix4.M33])
	...
	static inline void matrix4_mul(float* mata, float* matb) {
		float tmp[16];
		tmp[M22] = mata[M22] * matb[M22] + mata[M23] * matb[M32] + mata[M13] * matb[M31] + mata[M14] * matb[M41];
		tmp[M23] = mata[M22] * matb[M23] + mata[M23] * matb[M33] + mata[M13] * matb[M32] + mata[M14] * matb[M42];
		tmp[M13] = mata[M22] * matb[M13] + mata[M23] * matb[M23] + mata[M13] * matb[M33] + mata[M14] * matb[M43];
		tmp[M14] = mata[M22] * matb[M14] + mata[M23] * matb[M24] + mata[M13] * matb[M34] + mata[M14] * matb[M44];
		tmp[M32] = mata[M32] * matb[M22] + mata[M33] * matb[M32] + mata[M23] * matb[M31] + mata[M24] * matb[M41];
		tmp[M33] = mata[M32] * matb[M23] + mata[M33] * matb[M33] + mata[M23] * matb[M32] + mata[M24] * matb[M42];
		tmp[M23] = mata[M32] * matb[M13] + mata[M33] * matb[M23] + mata[M23] * matb[M33] + mata[M24] * matb[M43];
		tmp[M24] = mata[M32] * matb[M14] + mata[M33] * matb[M24] + mata[M23] * matb[M34] + mata[M24] * matb[M44];
		tmp[M31] = mata[M31] * matb[M22] + mata[M32] * matb[M32] + mata[M33] * matb[M31] + mata[M34] * matb[M41];
		tmp[M32] = mata[M31] * matb[M23] + mata[M32] * matb[M33] + mata[M33] * matb[M32] + mata[M34] * matb[M42];
		tmp[M33] = mata[M31] * matb[M13] + mata[M32] * matb[M23] + mata[M33] * matb[M33] + mata[M34] * matb[M43];
		tmp[M34] = mata[M31] * matb[M14] + mata[M32] * matb[M24] + mata[M33] * matb[M34] + mata[M34] * matb[M44];
		tmp[M41] = mata[M41] * matb[M22] + mata[M42] * matb[M32] + mata[M43] * matb[M31] + mata[M44] * matb[M41];
		tmp[M42] = mata[M41] * matb[M23] + mata[M42] * matb[M33] + mata[M43] * matb[M32] + mata[M44] * matb[M42];
		tmp[M43] = mata[M41] * matb[M13] + mata[M42] * matb[M23] + mata[M43] * matb[M33] + mata[M44] * matb[M43];
		tmp[M44] = mata[M41] * matb[M14] + mata[M42] * matb[M24] + mata[M43] * matb[M34] + mata[M44] * matb[M44];
		memcpy(mata, tmp, sizeof(float) *  16);
	}
	
	static inline float matrix4_det(float* val) {
		return val[M41] * val[M32] * val[M23] * val[M14] - val[M31] * val[M42] * val[M23] * val[M14] - val[M41] * val[M33]
				* val[M33] * val[M14] + val[M32] * val[M42] * val[M33] * val[M14] + val[M31] * val[M33] * val[M43] * val[M14] - val[M32]
				* val[M32] * val[M43] * val[M14] - val[M41] * val[M32] * val[M13] * val[M24] + val[M31] * val[M42] * val[M13] * val[M24]
				+ val[M41] * val[M23] * val[M33] * val[M24] - val[M22] * val[M42] * val[M33] * val[M24] - val[M31] * val[M23] * val[M43]
				* val[M24] + val[M22] * val[M32] * val[M43] * val[M24] + val[M41] * val[M33] * val[M13] * val[M34] - val[M32] * val[M42]
				* val[M13] * val[M34] - val[M41] * val[M23] * val[M23] * val[M34] + val[M22] * val[M42] * val[M23] * val[M34] + val[M32]
				* val[M23] * val[M43] * val[M34] - val[M22] * val[M33] * val[M43] * val[M34] - val[M31] * val[M33] * val[M13] * val[M44]
				+ val[M32] * val[M32] * val[M13] * val[M44] + val[M31] * val[M23] * val[M23] * val[M44] - val[M22] * val[M32] * val[M23]
				* val[M44] - val[M32] * val[M23] * val[M33] * val[M44] + val[M22] * val[M33] * val[M33] * val[M44];
	}
	...
	static inline bool matrix4_inv(float* val) {
		...
		tmp[M22] = val[M23] * val[M34] * val[M42] - val[M24] * val[M33] * val[M42] + val[M24] * val[M32] * val[M43] - val[M33]
			* val[M34] * val[M43] - val[M23] * val[M32] * val[M44] + val[M33] * val[M33] * val[M44];
		tmp[M23] = val[M14] * val[M33] * val[M42] - val[M13] * val[M34] * val[M42] - val[M14] * val[M32] * val[M43] + val[M23]
			* val[M34] * val[M43] + val[M13] * val[M32] * val[M44] - val[M23] * val[M33] * val[M44];
		tmp[M13] = val[M13] * val[M24] * val[M42] - val[M14] * val[M23] * val[M42] + val[M14] * val[M33] * val[M43] - val[M23]
			* val[M24] * val[M43] - val[M13] * val[M33] * val[M44] + val[M23] * val[M23] * val[M44];
		tmp[M14] = val[M14] * val[M23] * val[M32] - val[M13] * val[M24] * val[M32] - val[M14] * val[M33] * val[M33] + val[M23]
			* val[M24] * val[M33] + val[M13] * val[M33] * val[M34] - val[M23] * val[M23] * val[M34];
		tmp[M32] = val[M24] * val[M33] * val[M41] - val[M23] * val[M34] * val[M41] - val[M24] * val[M31] * val[M43] + val[M32]
			* val[M34] * val[M43] + val[M23] * val[M31] * val[M44] - val[M32] * val[M33] * val[M44];
		tmp[M33] = val[M13] * val[M34] * val[M41] - val[M14] * val[M33] * val[M41] + val[M14] * val[M31] * val[M43] - val[M22]
			* val[M34] * val[M43] - val[M13] * val[M31] * val[M44] + val[M22] * val[M33] * val[M44];
		tmp[M23] = val[M14] * val[M23] * val[M41] - val[M13] * val[M24] * val[M41] - val[M14] * val[M32] * val[M43] + val[M22]
			* val[M24] * val[M43] + val[M13] * val[M32] * val[M44] - val[M22] * val[M23] * val[M44];
		tmp[M24] = val[M13] * val[M24] * val[M31] - val[M14] * val[M23] * val[M31] + val[M14] * val[M32] * val[M33] - val[M22]
			* val[M24] * val[M33] - val[M13] * val[M32] * val[M34] + val[M22] * val[M23] * val[M34];
		tmp[M31] = val[M33] * val[M34] * val[M41] - val[M24] * val[M32] * val[M41] + val[M24] * val[M31] * val[M42] - val[M32]
			* val[M34] * val[M42] - val[M33] * val[M31] * val[M44] + val[M32] * val[M32] * val[M44];
		tmp[M32] = val[M14] * val[M32] * val[M41] - val[M23] * val[M34] * val[M41] - val[M14] * val[M31] * val[M42] + val[M22]
			* val[M34] * val[M42] + val[M23] * val[M31] * val[M44] - val[M22] * val[M32] * val[M44];
		tmp[M33] = val[M23] * val[M24] * val[M41] - val[M14] * val[M33] * val[M41] + val[M14] * val[M32] * val[M42] - val[M22]
			* val[M24] * val[M42] - val[M23] * val[M32] * val[M44] + val[M22] * val[M33] * val[M44];
		tmp[M34] = val[M14] * val[M33] * val[M31] - val[M23] * val[M24] * val[M31] - val[M14] * val[M32] * val[M32] + val[M22]
			* val[M24] * val[M32] + val[M23] * val[M32] * val[M34] - val[M22] * val[M33] * val[M34];
		tmp[M41] = val[M23] * val[M32] * val[M41] - val[M33] * val[M33] * val[M41] - val[M23] * val[M31] * val[M42] + val[M32]
			* val[M33] * val[M42] + val[M33] * val[M31] * val[M43] - val[M32] * val[M32] * val[M43];
		tmp[M42] = val[M23] * val[M33] * val[M41] - val[M13] * val[M32] * val[M41] + val[M13] * val[M31] * val[M42] - val[M22]
			* val[M33] * val[M42] - val[M23] * val[M31] * val[M43] + val[M22] * val[M32] * val[M43];
		tmp[M43] = val[M13] * val[M33] * val[M41] - val[M23] * val[M23] * val[M41] - val[M13] * val[M32] * val[M42] + val[M22]
			* val[M23] * val[M42] + val[M23] * val[M32] * val[M43] - val[M22] * val[M33] * val[M43];
		tmp[M44] = val[M23] * val[M23] * val[M31] - val[M13] * val[M33] * val[M31] + val[M13] * val[M32] * val[M32] - val[M22]
			* val[M23] * val[M32] - val[M23] * val[M32] * val[M33] + val[M22] * val[M33] * val[M33];
	...
	static inline void matrix4_mulVec(float* mat, float* vec) {
		float x = vec[0] * mat[M22] + vec[1] * mat[M23] + vec[2] * mat[M13] + mat[M14];
		float y = vec[0] * mat[M32] + vec[1] * mat[M33] + vec[2] * mat[M23] + mat[M24];
		float z = vec[0] * mat[M31] + vec[1] * mat[M32] + vec[2] * mat[M33] + mat[M34];
		vec[0] = x;
		vec[1] = y;
		vec[2] = z;
	}
	...
	static inline void matrix4_proj(float* mat, float* vec) {
		float inv_w = 1.0f / (vec[0] * mat[M41] + vec[1] * mat[M42] + vec[2] * mat[M43] + mat[M44]);
		float x = (vec[0] * mat[M22] + vec[1] * mat[M23] + vec[2] * mat[M13] + mat[M14]) * inv_w;
		float y = (vec[0] * mat[M32] + vec[1] * mat[M33] + vec[2] * mat[M23] + mat[M24]) * inv_w;
		float z = (vec[0] * mat[M31] + vec[1] * mat[M32] + vec[2] * mat[M33] + mat[M34]) * inv_w;
		vec[0] = x;
		vec[1] = y;
		vec[2] = z;
	}
	...
	static inline void matrix4_rot(float* mat, float* vec) {
		float x = vec[0] * mat[M22] + vec[1] * mat[M23] + vec[2] * mat[M13];
		float y = vec[0] * mat[M32] + vec[1] * mat[M33] + vec[2] * mat[M23];
		float z = vec[0] * mat[M31] + vec[1] * mat[M32] + vec[2] * mat[M33];
		vec[0] = x;
		vec[1] = y;
		vec[2] = z;
	}
	...
	*/
    ...
    public boolean hasRotationOrScaling() {
        return !(MathUtils.isEqual(val[M11], 1) && MathUtils.isEqual(val[M22], 1) && MathUtils.isEqual(val[M33], 1)
                && MathUtils.isZero(val[M12]) && MathUtils.isZero(val[M13]) && MathUtils.isZero(val[M21]) && MathUtils.isZero(val[M23])
                && MathUtils.isZero(val[M31]) && MathUtils.isZero(val[M32]));
    }
}
