...
import com.cyber.math.utils.NumberUtils;
...
public class Vector3 implements Serializable, Vector<Vector3> {
	...
	public Vector3 mul (final Matrix4 matrix) {
		...
		return this.set(x * l_mat[Matrix4.M11] + y * l_mat[Matrix4.M12] + z * l_mat[Matrix4.M13] + l_mat[Matrix4.M14], x
			* l_mat[Matrix4.M21] + y * l_mat[Matrix4.M22] + z * l_mat[Matrix4.M23] + l_mat[Matrix4.M24], x * l_mat[Matrix4.M31] + y
			* l_mat[Matrix4.M32] + z * l_mat[Matrix4.M33] + l_mat[Matrix4.M34]);
	}
	...
	public Vector3 traMul (final Matrix4 matrix) {
		final float l_mat[] = matrix.val;
		return this.set(x * l_mat[Matrix4.M11] + y * l_mat[Matrix4.M21] + z * l_mat[Matrix4.M31] + l_mat[Matrix4.M41], x
			* l_mat[Matrix4.M12] + y * l_mat[Matrix4.M22] + z * l_mat[Matrix4.M32] + l_mat[Matrix4.M42], x * l_mat[Matrix4.M13] + y
			* l_mat[Matrix4.M23] + z * l_mat[Matrix4.M33] + l_mat[Matrix4.M43]);
	}
	...
	public Vector3 mul (Matrix3 matrix) {
		final float l_mat[] = matrix.val;
		return set(x * l_mat[Matrix3.M11] + y * l_mat[Matrix3.M12] + z * l_mat[Matrix3.M13], x * l_mat[Matrix3.M21] + y
			* l_mat[Matrix3.M22] + z * l_mat[Matrix3.M23], x * l_mat[Matrix3.M31] + y * l_mat[Matrix3.M32] + z * l_mat[Matrix3.M33]);
	}
	...
	public Vector3 traMul (Matrix3 matrix) {
		final float l_mat[] = matrix.val;
		return set(x * l_mat[Matrix3.M11] + y * l_mat[Matrix3.M21] + z * l_mat[Matrix3.M31], x * l_mat[Matrix3.M12] + y
			* l_mat[Matrix3.M22] + z * l_mat[Matrix3.M32], x * l_mat[Matrix3.M13] + y * l_mat[Matrix3.M23] + z * l_mat[Matrix3.M33]);
	}
	...
	public Vector3 prj (final Matrix4 matrix) {
		final float l_mat[] = matrix.val;
		final float l_w = 1f / (x * l_mat[Matrix4.M41] + y * l_mat[Matrix4.M42] + z * l_mat[Matrix4.M43] + l_mat[Matrix4.M44]);
		return this.set((x * l_mat[Matrix4.M11] + y * l_mat[Matrix4.M12] + z * l_mat[Matrix4.M13] + l_mat[Matrix4.M14]) * l_w, (x
			* l_mat[Matrix4.M21] + y * l_mat[Matrix4.M22] + z * l_mat[Matrix4.M23] + l_mat[Matrix4.M24])
			* l_w, (x * l_mat[Matrix4.M31] + y * l_mat[Matrix4.M32] + z * l_mat[Matrix4.M33] + l_mat[Matrix4.M34]) * l_w);
	}
	...
	public Vector3 rot (final Matrix4 matrix) {
		final float l_mat[] = matrix.val;
		return this.set(x * l_mat[Matrix4.M11] + y * l_mat[Matrix4.M12] + z * l_mat[Matrix4.M13], x * l_mat[Matrix4.M21] + y
			* l_mat[Matrix4.M22] + z * l_mat[Matrix4.M23], x * l_mat[Matrix4.M31] + y * l_mat[Matrix4.M32] + z * l_mat[Matrix4.M33]);
	}
	...
	public Vector3 unrotate (final Matrix4 matrix) {
		final float l_mat[] = matrix.val;
		return this.set(x * l_mat[Matrix4.M11] + y * l_mat[Matrix4.M21] + z * l_mat[Matrix4.M31], x * l_mat[Matrix4.M12] + y
			* l_mat[Matrix4.M22] + z * l_mat[Matrix4.M32], x * l_mat[Matrix4.M13] + y * l_mat[Matrix4.M23] + z * l_mat[Matrix4.M33]);
	}
