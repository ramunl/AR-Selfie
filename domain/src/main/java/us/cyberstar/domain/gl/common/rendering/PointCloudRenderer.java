...
public class PointCloudRenderer {
     ...
     *
     * @param cameraView        the camera view matrix for this lastFrame, typically from {@link
     *                          com.google.ar.core.Camera#getViewMatrix(float[], int)}.
     * @param cameraPerspective the camera projection matrix for this lastFrame, typically from {@link
