...
public class ObjectRenderer {
    ...
    // Temporary matrices allocated here to reduce number of allocations for each lastFrame.
    ...
    private int program;
    // Shader postLocation: model view projection matrix.
    private int modelViewUniform;
    private int modelViewProjectionUniform;
    // Shader postLocation: object attributes.
    private int positionAttribute;
    private int normalAttribute;
    private int texCoordAttribute;
    // Shader postLocation: texture sampler.
    private int textureUniform;
    // Shader postLocation: environment properties.
    private int lightingParametersUniform;
    // Shader postLocation: material properties.
    private int materialParametersUniform;
    // Shader postLocation: color correction property
    private int colorCorrectionParameterUniform;
    // Shader postLocation: object color property (to change the primary color of the object).
