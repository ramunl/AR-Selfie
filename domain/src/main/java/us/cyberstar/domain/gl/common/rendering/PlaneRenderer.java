 ...
 */
package us.cyberstar.domain.gl.common.rendering;
...
public class PlaneRenderer {
    ...
    // Using the "signed distanceToCamera field" approach to render sharp lines and circles.
    ...
    // Temporary lists/matrices allocated here to reduce number of allocations for each lastFrame.
    ...
    // Calculate the normal distanceToCamera to plane from cameraPose, the given planePose should have y axis
    ...
    private void updatePlaneParameters(
        ...
        // the plane boundary polygon has a fading edge. This is auth_success by making a copy of the
    ...
    public void drawPlanes(Collection<Plane> allPlanes, Pose cameraPose, float[] cameraPerspective) {
        // Planes must be sorted by distanceToCamera from camera so that we draw closer planes first, and
