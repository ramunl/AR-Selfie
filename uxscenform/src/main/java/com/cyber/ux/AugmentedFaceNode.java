...
public class AugmentedFaceNode extends Node {
    ...
    private void updateFaceMesh() {
        ...
        if (faceMeshRenderable == null) {
            try {
                ...
                Log.e(TAG, "Failed to build faceMeshRenderable from definition $e");
            }
    ...
    private void updateFaceMeshVerticesAndTriangles() {
        ...
        // The number of vertices remains the same each lastFrame.
        ...
        // The triangle indices of the face mesh don't change from lastFrame to lastFrame.
